...
if (navigator.userAgent.toLowerCase().includes("cydia")) {
    ...
    for (const e of document.getElementsByClassName("leftNavButton")) e.style.display = "none";
    popupButtonWrapper.style.bottom = "calc(100% - 300px)";
    document.getElementById("bannerWrapper").style.display = "none";
}
function screenshotViewCydia(element) {
    window.location.href = 
        //"https://pinpal.github.io/Sileo-Depiction-WebViews/screenshotViewCydia/?image=" 
        "https://repo.p0358.net/depiction-webviews/screenshotViewCydia/?image=" 
        + element.src 
        + "&back="
        + window.location.href
}